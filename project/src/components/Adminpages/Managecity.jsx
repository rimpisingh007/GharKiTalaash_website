            ...
            >
                ...
                <div className="row no-gutters slider-text align-items-end">
                    ...
                    <p className="breadcrumbs mb-2">
                        ...
                        <span>
                        Manage Cities<i className="ion-ios-arrow-forward" />
                        </span>
                    </p>
                    <h1 className="mb-0 bread">Manage Cities</h1>
                    </div>
                </div>
                </div>
            </section>
            ...
            <div className="row justify-content-center no-gutters">
              <div className="col-md-12" style={{boxShadow:"0px 0px 15px gray"}}>
                <div className="d-flex justify-content-end p-2">
                    <Link to={"/admin/city/add"} className="btn btn-outline-primary">Add New +</Link>
                </div>
