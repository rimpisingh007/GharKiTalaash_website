...
export default function ManagePG(){
    ...
    const DeletePg= (PgId)=>{
        ...
        if (result.isConfirmed) {
            await deleteDoc(doc(db,"pga",PgId))
            .then(()=>{
                Swal.fire({
                title: "Deleted!",
            ...
            >
                ...
                <div className="row no-gutters slider-text align-items-end">
                    ...
                    <p className="breadcrumbs mb-2">
                        ...
                        <span>
                        Manage Pgs<i className="ion-ios-arrow-forward" />
                        </span>
                    </p>
                    <h1 className="mb-0 bread">Manage Pg/Property</h1>
                    </div>
                </div>
                </div>
            </section>
            ...
            <div className="row justify-content-center no-gutters">
              <div className="col-md-12" style={{boxShadow:"0px 0px 15px gray"}}>
                <div className="d-flex justify-content-end p-2">
                    <Link to={"/admin/pg/add"} className="btn btn-outline-primary">Add New +</Link>
                </div>
                <div className="contact-wrap w-100 p-md-5 p-4">
                  <h3 className="mb-4">Pg/Property</h3>
                    ...
                    AllPgs.map((el,index)=>{
                        return <tbody>
                                        ...
                                        <td>{el.description}</td>
                                         ...
                                         <td>
                                            <Link to={"/admin/pg/edit/"+el.id} className="btn btn-outline-success mx-2">Edit</Link>
